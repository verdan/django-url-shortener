...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'shortener_tinyurl', (
            ...
            ('linked_with', self.gf('django.db.models.fields.related.OneToOneField')(related_name='tinny_url', unique=True, to=orm['shortener.SecretWord'])),
    ...
    models = {
        ...
        u'shortener.tinyurl': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'linked_with': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'tinny_url'", 'unique': 'True', 'to': u"orm['shortener.SecretWord']"})
        }
    }
