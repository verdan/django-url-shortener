...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(u'shortener_tinyurl', 'linked_with_id',
                        self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True,
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TinyUrl.linked_with'
        db.alter_column(u'shortener_tinyurl', 'linked_with_id',
                        self.gf('django.db.models.fields.related.OneToOneField')(default=1, unique=True,
                                                                                 to=orm['shortener.SecretWord']))
    ...
    models = {
        ...
        u'shortener.tinyurl': {
            ...
            'linked_with': ('django.db.models.fields.related.OneToOneField', [],
                            {'blank': 'True', 'related_name': "'tinny_url'", 'unique': 'True', 'null': 'True',
                             'to': u"orm['shortener.SecretWord']"})
        }
    }
